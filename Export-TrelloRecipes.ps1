Function Export-TrelloRecipes {
	...
	.EXAMPLE
		PS> Export-TrelloRecipes -BoardName "Recipes" -Path "D:\trello-meal-plan\examples\backup"
	...
	Process {
        ...
        ForEach ($card in $cards) {
            ...
            $attachmentUrl = ($card | Get-TrelloCardAttachment).Url
            Write-Output $attachmentUrl 
            Invoke-WebRequest $attachmentUrl -OutFile $filePathImage
        }
